...
export const PANELS = {
  ...
  veracruz: { title: "Veracruz, el no-brainer geográfico", body: "Tercer estado en adultos mayores en número absoluto (1,157,892), segundo en porcentaje de 60+ (14.4%), marginación alta y de las mayores tasas de mortalidad por diabetes del país (15.6 por 10 mil en 2021, solo detrás de Puebla). Cuatro señales oficiales apuntan al mismo lugar. Es el caso más sólido para la primera jornada." },
